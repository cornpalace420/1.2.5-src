...
import org.lwjgl.opengl.GL11.DetectAnisotropicGlitch;
import org.lwjgl.opengl.GL11.WebGL2RenderingContext;
...
public class Client {
		...
		public static void main(String args[]) {
			rootElement = Window.current().getDocument().getBody();
		...
		private static String addWebGLToCrash() {
			...
			WebGLRenderingContext ctx = webgl;
			...
			if(ctx != null) {
				if(webgl != null) {
					ret.append("webgl.version = ").append(ctx.getParameterString(WebGL2RenderingContext.VERSION)).append('\n');
				}
				if(ctx.getExtension("WEBGL_debug_renderer_info") != null) {
					...
					ret.append("webgl.renderer = ").append("" + ctx.getParameterString(WebGL2RenderingContext.RENDERER) + " [masked]").append('\n');
				...
				try {
					...
					if(ctx != null) {
						...
						if(ctx.getExtension("WEBGL_debug_renderer_info") != null) {
							...
							r = ctx.getParameterString(WebGL2RenderingContext.RENDERER);
							if(r != null) {
								r += " [masked]";
							}
						}
