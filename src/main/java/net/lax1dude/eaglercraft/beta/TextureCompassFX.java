...
public class TextureCompassFX extends TextureFX {
	...
	public TextureCompassFX() {
		...
		tileImage = 1;
		this.compassSpriteSheet = EaglerAdapterImpl2.loadPNG(EaglerAdapterImpl2.loadResourceBytes("/sprite_sheet/compass.png")).swapRB().getData();
	...
	public void updateCompass(World par1World, double par2, double par4, double par6, boolean par8, boolean par9) {
		...
		if (par1World != null && !par8) {
			...
			if (!par1World.worldProvider.func_48217_e()) {
