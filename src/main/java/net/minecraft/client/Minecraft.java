...
import net.lax1dude.eaglercraft.beta.TextureClockFX;
import net.lax1dude.eaglercraft.beta.TextureCompassFX;
...
public class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		Display.setTitle("Minecraft 1.2.5");
		System.out.println("LWJGL Emulator Version: 2.9.3");

		OpenGlHelper.initializeTextures();
		this.saveLoader = new EaglerSaveFormat("minecraft/saves");
		...
		this.statFileWriter = new StatFileWriter(this.session);
		...
		this.renderEngine.registerTextureFX(new TextureCompassFX());
		this.renderEngine.registerTextureFX(new TextureClockFX());
		this.renderEngine.registerSpriteSheet("portal", Block.portal.blockIndexInTexture, 1);
		this.renderEngine.registerSpriteSheet("water", Block.waterStill.blockIndexInTexture, 1);
		this.renderEngine.registerSpriteSheet("water_flow", Block.waterMoving.blockIndexInTexture + 1, 2);
		this.renderEngine.registerSpriteSheet("lava", Block.lavaStill.blockIndexInTexture, 1);
		this.renderEngine.registerSpriteSheet("lava_flow", Block.lavaMoving.blockIndexInTexture + 1, 2);
		this.renderEngine.registerSpriteSheet("fire_0", Block.fire.blockIndexInTexture, 1);
		this.renderEngine.registerSpriteSheet("fire_1", Block.fire.blockIndexInTexture + 16, 1);
	...
	private void runGameLoop() {
		...
		GL11.glEnable(GL11.GL_TEXTURE_2D);
		if(!(Keyboard.getEventKey() == 8 && Keyboard.isKeyDown(33))) {
			Display.update();
		}
		...
		for(this.isGamePaused = !this.isMultiplayerWorld() && this.currentScreen != null && this.currentScreen.doesGuiPauseGame(); System.currentTimeMillis() >= this.debugUpdateTime + 1000L;) {
			...
			while(true) {
				while(true) {
					...
					if(this.currentScreen != null) {
						...
						if(Keyboard.getEventKey() == 31 && Keyboard.isKeyDown(4) && Keyboard.isKeyDown(33)) {
							this.forceReload();
						}

						if(Keyboard.getEventKey() == 20 && Keyboard.isKeyDown(4) && Keyboard.isKeyDown(33)) {
							this.renderEngine.refreshTextures();
						}

						if(Keyboard.getEventKey() == 30 && Keyboard.isKeyDown(4) && Keyboard.isKeyDown(33)) {
							this.renderGlobal.loadRenderers();
						}

						if(Keyboard.getEventKey() == 2 && Keyboard.isKeyDown(33)) {
							this.gameSettings.hideGUI = !this.gameSettings.hideGUI;
						}

						if(Keyboard.getEventKey() == 4 && Keyboard.isKeyDown(33)) {
							this.gameSettings.showDebugInfo = !this.gameSettings.showDebugInfo;
							this.gameSettings.field_50119_G = !GuiScreen.func_50049_m();
						}

						if(Keyboard.getEventKey() == 6 && Keyboard.isKeyDown(33)) {
						...
						if(Keyboard.getEventKey() == 9 && Keyboard.isKeyDown(33)) {
							this.gameSettings.smoothCamera = !this.gameSettings.smoothCamera;
						}
						
						if(Keyboard.getEventKey() == 3 && Keyboard.isKeyDown(33)) {
							if(!this.isTakingScreenshot) {
								System.out.println("Screenshot!");
								this.isTakingScreenshot = true;
								this.ingameGUI.addChatMessage("Saved screenshot as " + GL11.EaglerAdapterImpl2.saveScreenshot());
							}
						} else {
	...
	public static void startMainThread(String var0, String var1, String var2) {
		boolean var3 = false;
		Minecraft var7 = new Minecraft(Display.getWidth(), Display.getHeight(), var3);
	...
	public static void func_52004_D() {
		...
		var0.func_52022_a("memory_total", 1024*1024*1024);
		var0.func_52022_a("memory_max", 1024*1024*1024);
		var0.func_52022_a("java_version", "TeaVM");
		var0.func_52022_a("opengl_version", "2.9.3");
		var0.func_52022_a("opengl_vendor", GL11.EaglerAdapterImpl2.webgl.getParameterString(WebGLRenderingContext.VENDOR));
		var0.func_52021_a();
	}
