...
public class VillageSiege {
	...
	private boolean func_48574_b() {
		...
		do {
			...
			var10 = this.func_48572_a(this.field_48577_g, this.field_48583_h, this.field_48584_i);
		} while(var10 == null);
	...
	private Vec3D func_48572_a(int var1, int var2, int var3) {
		for(int var4 = 0; var4 < 10; ++var4) {
			int var5 = var1 + this.field_48582_a.rand.nextInt(16) - 8;
			int var6 = var2 + this.field_48582_a.rand.nextInt(6) - 3;
			int var7 = var3 + this.field_48582_a.rand.nextInt(16) - 8;
