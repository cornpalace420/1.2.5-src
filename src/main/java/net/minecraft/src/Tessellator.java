...
public class Tessellator {
	...
	public void addVertex(double var1, double var3, double var5) {
		...
		floatBuffer0.set(bufferIndex + 0, (float) (var1 + this.xOffset));
		floatBuffer0.set(bufferIndex + 1, (float) (var3 + this.yOffset));
		floatBuffer0.set(bufferIndex + 2, (float) (var5 + this.zOffset));
