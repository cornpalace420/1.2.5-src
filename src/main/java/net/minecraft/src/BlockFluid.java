	...
	public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if(this.blockMaterial == Material.lava && var1.getBlockMaterial(var2, var3 + 1, var4) == Material.air && !var1.isBlockOpaqueCube(var2, var3 + 1, var4)) {
			if(var5.nextInt(100) == 0) {
				...
				var1.playSoundEffect(var21, var22, var23, "liquid.lavapop", 0.2F + var5.nextFloat() * 0.2F, 0.9F + var5.nextFloat() * 0.15F);
			}
		...
		if(var5.nextInt(10) == 0 && var1.isBlockNormalCube(var2, var3 - 1, var4) && !var1.getBlockMaterial(var2, var3 - 2, var4).blocksMovement()) {
			var21 = (double)((float)var2 + var5.nextFloat());
