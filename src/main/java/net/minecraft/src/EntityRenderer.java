...
public class EntityRenderer {
		...
		if(var1 != null) {
			for(int var2 = 0; var2 < 256; ++var2) {
				...
				if(var1.worldProvider.worldType == 1) {
					var12 = 0.22F + var5 * (12.0F / 16.0F);
					var13 = 0.28F + var10 * (12.0F / 16.0F);
					var14 = 0.25F + var11 * (12.0F / 16.0F);
				}
	...
	private void updateFogColor(float var1) {
		...
		double var14 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)var1) * var2.worldProvider.getVoidFogYFactor();
