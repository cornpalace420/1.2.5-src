...
public class GuiEnchantment extends GuiContainer {
	...
	public GuiEnchantment(InventoryPlayer var1, World var2, int var3, int var4, int var5) {
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		float var10 = this.field_40221_n + (this.field_40224_m - this.field_40221_n) * var1;
		...
		float var11 = this.field_40225_j + (this.field_40229_i - this.field_40225_j) * var1 + 0.25F;
		float var12 = this.field_40225_j + (this.field_40229_i - this.field_40225_j) * var1 + 12.0F / 16.0F;
		...
		bookModel.render((Entity)null, 0.0F, var11, var12, var10, 0.0F, 1.0F / 16.0F);
