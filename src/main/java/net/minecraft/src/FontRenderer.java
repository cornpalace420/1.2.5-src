...
public class FontRenderer {
	...
	public FontRenderer(GameSettings var1, String var2, RenderEngine var3, boolean var4) {
		...
		BufferedImage var5;
		try {
			var5 = ImageIO.read(ImageIO.getResourceAsStream(var2));
			InputStream var6 = ImageIO.getResourceAsStream("/font/glyph_sizes.bin");
	...
	private void loadGlyphTexture(int var1) {
		...
		BufferedImage var2;
		try {
			var2 = ImageIO.read(ImageIO.getResourceAsStream(var3));
