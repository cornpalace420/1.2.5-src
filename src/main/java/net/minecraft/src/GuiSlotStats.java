		...
		if(var2 >= this.top && var2 <= this.bottom) {
			...
			if(var3 >= 0) {
				...
				if(var5.length() > 0) {
					int var6 = var1 + 12;
					int var7 = var2 - 12;
					int var8 = GuiStats.getFontRenderer8(this.field_27269_g).getStringWidth(var5);
					GuiStats.drawGradientRect(this.field_27269_g, var6 - 3, var7 - 3, var6 + var8 + 3, var7 + 8 + 3, -1073741824, -1073741824);
					GuiStats.getFontRenderer9(this.field_27269_g).drawStringWithShadow(var5, var6, var7, -1);
				}
			}
