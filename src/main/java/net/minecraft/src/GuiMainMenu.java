...
public class GuiMainMenu extends GuiScreen {
	...
	public GuiMainMenu() {
		try {
			...
			BufferedReader var2 = new BufferedReader(new InputStreamReader(ImageIO.getResourceAsStream("/title/splashes.txt"), Charset.forName("UTF-8")));
			String var3 = "";
	...
	public void initGui() {
		this.viewportTexture = this.mc.renderEngine.makeViewport(256, 256);
	...
	private void drawPanorama(int var1, int var2, float var3) {
		...
		for(int var6 = 0; var6 < var5 * var5; ++var6) {
			...
			for(int var10 = 0; var10 < 6; ++var10) {
				...
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexturePanorama("/title/bg/panorama" + var10 + ".png"));
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexturePanorama("/title/mclogo.png"));
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
