...
public class Block {
	...
	public static final Block brewingStand = (new BlockBrewingStand(117)).setHardness(0.5F).setLightValue(2.0F / 16.0F).setBlockName("brewingStand").setRequiresSelfNotify();
	...
	public int getMixedBrightnessForBlock(IBlockAccess var1, int var2, int var3, int var4) {
		return var1.getLightBrightnessForSkyBlocks(var2, var3, var4, lightValue[this.blockID]);
	}
