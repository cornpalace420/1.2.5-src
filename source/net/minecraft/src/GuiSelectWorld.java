...
public class GuiSelectWorld extends GuiScreen {
	...
	public void selectWorld(int var1) {
		...
		if(!this.selected) {
			this.selected = true;
			int var2 = ((SaveFormatComparator)this.saveList.get(var1)).getGameType();
			if(var2 == 0) {
	...
	static String getLocalizedWorldName(GuiSelectWorld var0) {
	...
	static String getLocalizedMustConvert(GuiSelectWorld var0) {
		return var0.localizedMustConvertText;
	}

	static String[] getLocalizedGameMode(GuiSelectWorld var0) {
